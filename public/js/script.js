    ...
    for (let question in answers) {
        ...
        if (selected) {
            ...
            if (selectedValue === answers[question].correctAnswer) {
                score++;
                answerDiv.innerHTML = `<span style="color: green;">Correto.<br>Explicação: ${answers[question].explanation}</span>`;
            } else {
                answerDiv.innerHTML = `<span style="color: red;">Errado.<br>Explicação: ${answers[question].explanation}</span>`;
            }
        } else {
            answerDiv.innerHTML = `<span style="color: red;">Nenhuma resposta selecionada.<br>Explicação: ${answers[question].explanation}</span>`;
        }
